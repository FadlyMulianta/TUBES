...
<head>
    ...
    <title>Beranda</title>
    <link rel="stylesheet" href="{{ asset('css/mainberanda.css') }}">
</head>
    ...
    <main>
            ...
            <div class="dokter-judul">
                ...
                <div class="kebawah">
                    <a href="#kesini">
                        ...
                        <img src="{{ asset('asset/ikon/triple-down-chevron.png') }}" alt="" id="kesini">
                    </a>
        ...
        <section class="dokter">
            ...
            <div class="lihat-semua-top">
                <a class="lihat-semua" href="{{ route('dokter') }}">
                    <div>
                        <h4>Semua Dokter</h4>
                    </div>
                    <img src="{{ asset('asset/ikon/next.png') }}" alt="">
                </a>
            </div>
            ...
            <div id="customCarousel" class="carousel">
                ...
                <div>
                    ...
                    <button class=" carousel-control-next" aria-label="Next Slide">
                        <div>
                            <img src="{{ asset('asset/ikon/chevron kanan.png') }}" alt="" style="width: 70%; ma">
                        </div>
                    </button>
                </div>
            </div>
        ...
        <!-- <div class="produk-grid">
            ...
            <div class="lihat-semua-top">
                <a class="lihat-semua" href="{{ route('produk') }}">
                    <div>
                        <h4>Semua Produk</h4>
                    </div>
                    <img src="{{ asset('asset/ikon/next.png') }}" alt="">
